...
\r
export { }\r
`;async function u(){return void 0===r&&((r=await Promise.all([t.e("4014"),t.e("8177"),t.e("8289")]).then(t.bind(t,76648))).typescript.typescriptDefaults.addExtraLib(l,"file:///node_modules/@types/inversify.d.ts"),r.typescript.typescriptDefaults.setCompilerOptions({allowSyntheticDefaultImports:!0,experimentalDecorators:!0,moduleResolution:r.typescript.ModuleResolutionKind.NodeJs,target:r.typescript.ScriptTarget.ES2020})),r}function p({beforeCodeRun:e,Button:n,onPlan:t,style:r}){let a=function(){let[e,n]=(0,s.useState)(!1);return(0,s.useEffect)(()=>{!async function(){await (0,o.Ay)(),n(!0)}()},[]),e}(),l=(0,s.useRef)(t);(0,s.useEffect)(()=>{l.current=t},[t]);let p=(0,s.useRef)(function(e){let n=new Blob([c],{type:"text/javascript"}),t=URL.createObjectURL(n),r=new Worker(t,{type:"module"});URL.revokeObjectURL(t);let i=1,a=new Map;function o(e){let n=a.get(e);if(void 0!==n)return a.delete(e),n}return r.addEventListener("error",e=>{let n=Error(`Worker error: ${e.message}`,{cause:e.error});for(let e of a.values())e.reject(n);a.clear()}),r.addEventListener("message",n=>{switch(n.data.kind){case"error":{let e=o(n.data.id);if(void 0===e)return;e.reject(n.data.error)}break;case"plan":e?.onPlan?.(n.data.options,n.data.result);break;case"success":{let e=o(n.data.id);if(void 0===e)return;e.resolve(n.data.result)}}}),r.addEventListener("messageerror",()=>{let e=Error("Worker message serialization error");for(let n of a.values())n.reject(e);a.clear()}),{rpc:async function(e,n){let t=i++;return new Promise((i,o)=>{a.set(t,{reject:o,resolve:i}),r.postMessage({args:e,code:n,id:t})})},terminate:()=>{r.terminate()}}}({onPlan:(e,n)=>l.current?.(e,n)})),v=(0,s.useRef)(null),h=(0,s.useRef)(null),[f,g]=s.useState(!0);(0,s.useEffect)(()=>(v.current&&(async()=>{let e,n=await u(),t=(e=n.Uri.parse("file:///main.ts"),n.editor.getModel(e)??n.editor.createModel(`
...
`.trim(),"typescript",e));h.current=n.editor.create(v.current,{model:t}),g(!1)})(),()=>{null!==h.current&&h.current.dispose(),p.current.terminate()}),[]);let y={...r,position:"relative"};return(0,i.jsxs)("div",{style:y,children:[(0,i.jsx)("div",{className:"_spinnerOverlay_1ifuj_24",style:{display:f?"flex":"none"},children:(0,i.jsx)("div",{className:"_spinnerDot_1ifuj_15"})}),(0,i.jsx)("div",{style:{height:"calc(100% - 40px)",width:"100%"},children:(0,i.jsx)("div",{ref:v,className:"_reactMonacoEditorContainer_1ifuj_10"})}),(0,i.jsx)("div",{children:(0,i.jsx)(n,{onClick:()=>{if(null!==h.current&&a){var n;e?.();let t=function(e,n){for(let[e,t]of n)void 0===d.availablePlugins[e]&&(0,d.registerPlugin)(e,t);return(0,d.transform)(e,{filename:"main.ts",plugins:[...n.map(([e])=>[e])],sourceType:"module"}).code??""}((0,o.Uz)(h.current.getValue(),{jsc:{parser:{decorators:!0,syntax:"typescript"},target:"es2022",transform:{decoratorMetadata:!0,legacyDecorator:!0}},module:{type:"es6"}}).code,[["customMapImports",(n={inversify:`${window.location.origin}/inversify.js`},()=>({visitor:{ImportDeclaration(e){let t=n[e.node.source.value];void 0!==t&&(e.node.source=d.packages.types.stringLiteral(t))}}}))]]);p.current.rpc([],t)}},label:"Run"})})]})}var v=t(47692),h=t(99793),f=t(91166),g=t(4921);function y({block:e=!1,className:n,disabled:t=!1,onClick:r,outline:a=!1,label:o,link:s,size:d,style:c,variant:l="primary"}){let u="lg"===d||"sm"===d?`button--${d}`:"",p=`button--${l}`,v=t?null:s??null;return(0,i.jsx)(f.A,{...null===v?{}:{to:v},children:(0,i.jsx)("button",{"aria-disabled":t,className:(0,g.A)("button",u,a?"button--outline":"",p,e?"button--block":"",t?"disabled":"",n),onClick:r,role:"button",style:c,children:o})})}var x=t(43861);x.A.initialize({});let m=({source:e,id:n})=>{let t=(0,s.useRef)(null);return(0,s.useEffect)(()=>{void 0!==e&&(async()=>{if(null!==t.current){t.current.innerHTML=e;let{svg:r,bindFunctions:i}=await x.A.render(`mermaid-diagram-${n}`,e);t.current.innerHTML=r,i?.(t.current)}})()},[n,e]),(0,i.jsx)("div",{id:n,ref:t})};function T(e){return e.replace(/\n/g,"<br />").replace(/\r/g,"").replace(/\t/g,"  ").replace(/([[\]{}\\"<>])/g,"\\$1")}function b(e){return"string"==typeof e?e:"symbol"==typeof e?e.toString():"function"==typeof e||"object"==typeof e?""===e.name?"AnonymousFunction":e.name:"Unknown"}function j(e){return"classMetadata"in e&&"constructorParams"in e}function I(e){return"params"in e&&!("classMetadata"in e)}function S(e){return"redirections"in e}function B({style:e}){let[n,t]=(0,s.useState)([]),[r,o]=(0,s.useState)(void 0),d=void 0!==r?n[r]:void 0;return(0,i.jsx)(a.A,{children:()=>(0,i.jsx)(i.Fragment,{children:(0,i.jsxs)(h.A,{children:[(0,i.jsx)(v.A,{value:"editor",label:"Editor",children:(0,i.jsx)(p,{beforeCodeRun:()=>{t([]),o(void 0)},Button:y,onPlan:(e,r)=>{var i;let a=function(e,n){let t=["flowchart TD"],r=0,i=new Map;function a(e,n){let t=i.get(e);if(void 0===t){var a;let t=(a=r++,`${n}_${String(a)}`);return i.set(e,t),t}return t}function o(e){let n=a(e,"service"),r=T(b(e.serviceIdentifier));if(t.push(`${n}["ServiceNode<br/>Service identifier: ${r}<br/>Is context free: ${String(e.isContextFree)}"]`),void 0!==e.bindings)if(Array.isArray(e.bindings))for(let t of e.bindings)s(t,n);else s(e.bindings,n);return n}function s(e,n){if(j(e))!function(e,n){let r=a(e,"instance"),i=e.binding.type,s=T(e.binding.implementationType.name);t.push(`${r}["${i}: ${s}<br/>Binding scope: ${e.binding.scope}"]`),t.push(`${n} --> ${r}`);for(let n=0;n<e.constructorParams.length;n++){let i=e.constructorParams[n];if(void 0!==i){let e=o(i);t.push(`${r} -.->|param ${String(n)}| ${e}`)}}if(e.propertyParams.length>0)for(let[n,i]of e.propertyParams){let e=T(String(n)),a=o(i);t.push(`${r} -.->|prop: ${e}| ${a}`)}}(e,n);else if(I(e))!function(e,n){let r=a(e,"resolved"),i=e.binding.type;t.push(`${r}["${i}<br/>Binding scope: ${e.binding.scope}"]`),t.push(`${n} --> ${r}`);for(let n=0;n<e.params.length;n++){let i=e.params[n];if(void 0!==i){let e=o(i);t.push(`${r} -.->|param ${String(n)}| ${e}`)}}}(e,n);else if(S(e)){var r=e,i=n;let o=a(r,"redirect"),d=T(b(r.binding.targetServiceIdentifier));for(let e of(t.push(`${o}["ServiceRedirection \u{2192} ${d}"]`),t.push(`${i} --> ${o}`),r.redirections))s(e,o)}else j(e)||I(e)||S(e)||function(e,n){let r=a(e,"leaf"),i=e.binding.type,o=i;if("ConstantValue"===i&&"value"in e.binding){let n,t=e.binding.value;n=null===t?"null":void 0===t?"undefined":"object"==typeof t?T("{...}"):"string"==typeof t?T(t.slice(0,30)):"number"==typeof t||"boolean"==typeof t?T(String(t)):"symbol"==typeof t?T(t.toString()):typeof t,o=`${i}: ${n}`}t.push(`${r}["${o}<br/>Binding scope: ${e.binding.scope}"]`),t.push(`${n} --> ${r}`)}(e,n)}let d="root",c=T(b(e.serviceIdentifier)),l=e.optional?" (optional)<br/>":"",u="isMultiple"in e&&e.isMultiple?" (multiple)<br/>":"",p=void 0!==e.name?`Name: "${String(e.name)}"<br/>`:"";return t.push(`${d}["Request:<br/>Service identifier: ${c}<br/>${p}${l}${u}"]`),t.push(`style ${d} fill:#e1f5ff,stroke:#0288d1,stroke-width:3px`),o(n.tree.root),t.push(`${d} --> ${a(n.tree.root,"service")}`),t.join("\n")}(e,r),s="string"==typeof(i=e.serviceIdentifier)?i:"symbol"==typeof i?i.toString():"function"==typeof i||"object"==typeof i?""===i.name?"AnonymousFunction":i.name:"Unknown";t(n=>[...n,{displayName:s,serviceIdentifier:e.serviceIdentifier,source:a}]),o(e=>void 0===e?0:n.length)},style:e})}),(0,i.jsxs)(v.A,{value:"graph",label:"Graph",children:[0===n.length?(0,i.jsx)("p",{children:"Run the code to generate a dependency graph."}):(0,i.jsxs)("div",{style:{marginBottom:"1rem",marginTop:"1rem"},children:[(0,i.jsx)("label",{htmlFor:"graph-selector",style:{marginRight:"0.5rem"},children:"Select Graph:"}),(0,i.jsx)("select",{id:"graph-selector",value:r??"",onChange:e=>{o(Number(e.target.value))},style:{border:"1px solid var(--ifm-color-emphasis-300)",borderRadius:"4px",padding:"0.5rem"},children:n.map((e,n)=>(0,i.jsx)("option",{value:n,children:e.displayName},n))})]}),(0,i.jsx)(m,{source:d?.source,id:"mermaid-graph"})]})]})})})}}}]);